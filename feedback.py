...
answer_list1 = [
"Because her  grandmother is sick.",
"To give to her grandmother, to help her grandmother feel better",
"to protect little red riding hood, because a stranger might hurt little red riding hood",
"a wolf",
"what she is doing in the forest, where she is going",
"yes",
"no",
"because he/the wolf is a stranger, because he is bad, because he might hurt her/Little Red Riding Hood",
"He goes to Little Red Riding Hood's grandmother's house,he takes a shortcut to Little Red Riding Hood's grandmother's house.",
"He locks Little Red Riding Hood's grandmother in the closet, he dresses like Little Red Riding Hood's grandmother and goes in her bed",
"because the wolf doesn't look like Little Red Riding Hood's grandmother, because the wolf's eyes/ears/teeth don't look like Little Red Riding Hood's grandmother's eyes/ears/teeth ",
"he/the wolf tries to eat her",
"the woodsman lumberjack",
"Don't talk to strangers/Listen to your mom/parents"
               ]
...
class feedback:
    ...
    def checkanswer(self, answer = " answer ", question_id = 0):
        ...
        score = self.core.get_score(answer, answer_list1[question_id])
        if score[0] < 0.85:
